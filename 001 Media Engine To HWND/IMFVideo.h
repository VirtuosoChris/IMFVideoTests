...
#define CHECKLN_HRESULT( CODE_IN ) CHECK_HRESULT( CODE_IN, #CODE_IN );
...
namespace Virtuoso
{
    namespace Win32
    {
        ...
        union RenderTarget
        {
            ...
            RenderTarget& operator=(const DXTexture& texIn)
            {
                this->texture = texIn;
                return *this;
            }
        ...
        void videoRender(IMFMediaEngine* mediaEngine, Virtuoso::Win32::DXTexture texture, RECT dimensions)
        {
            LONGLONG pts;
            ...
            if (mediaEngine->OnVideoStreamTick(&pts) == S_OK)
            {
                ...
                CHECKLN_HRESULT(mediaEngine->TransferVideoFrame(texture, nullptr, &dimensions, &border));
            }
        }
            ...
            bool isHWND)
        {
            ...
            CHECK_HRESULT(MFCreateAttributes(&attributes, 2), "MFCreateAttributes() error: failed to create IMFAttributes for media engine");
            ...
            else // Frame-server mode
            {
                ...
                CHECKLN_HRESULT(attributes->SetUINT32(MF_MEDIA_ENGINE_VIDEO_OUTPUT_FORMAT, D3DFMT_R8G8B8));
            }
        ...
        struct IMFMediaPlayer : public CallbackInterface
        {
            ...
            void playMedia()
            {
                ...
                assert(target.hwnd != 0 || target.texture != nullptr);
            ...
            IMFMediaPlayer(HWND hwnd) : target({ hwnd })
            {
                ...
                videoInit(&mediaEngine, this, target, true);
            }
            ...
            IMFMediaPlayer()
            {
                ...
                videoInit(&mediaEngine, this, target, false);
            }
